...
package com.littlepanpc.downloader.http;
...
/**
 * @class: HttpDateTime
 * @Description: Helper for parsing an HTTP date.
 * @author: Peter Pan
 * @email: happychinapc@gmail.com
 * @date: 2014-5-20 下午4:24:52
 * @since: 1.0.0
 *
 */
public final class HttpDateTime {
	...
	/**
	 * @Title: parse
	 * @Description: parse time in String to time in long
	 * @param timeString
	 * @return
