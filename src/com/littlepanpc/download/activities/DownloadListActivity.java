...
import com.littlepanpc.download.services.TrafficCounterService;
import com.littlepanpc.download.utils.IndexConstants;
import com.littlepanpc.download.utils.StorageUtils;
import com.littlepanpc.download.utils.Utils;
import com.littlepanpc.download.widgets.DownloadListAdapter;
import com.littlepanpc.download.widgets.ViewHolder;
...
public class DownloadListActivity extends Activity implements OnClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		downloadIntent = new Intent(
				"com.littlepanpc.download.services.DownloadService");
		...
		filter.addAction("com.littlepanpc.download.activities.DownloadListActivity");
	...
	public class MyReceiver extends BroadcastReceiver {
		...
		private void handleIntent(Intent intent) {
			if (intent != null
					&& intent
							.getAction()
							.equals("com.littlepanpc.download.activities.DownloadListActivity")) {
